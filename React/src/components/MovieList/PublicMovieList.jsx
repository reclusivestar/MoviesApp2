 ...
 * ];
 */
class PublicMovieList extends Component {
  constructor(props) {
     super(props);
     if (this.props.userOnly && this.props.Prss.role === 0) {
...
export default withStyles(styles)(PublicMovieList) 
